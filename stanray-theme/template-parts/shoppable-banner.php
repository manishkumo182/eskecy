...
// ── CONFIG: set product_id and pin position (% from top/left) ──
$hotspots = [
    ...
    <div class="sb__inner">
        ...
        <div class="sb__panel">
            ...
            <div class="sb__panel-head">
                <p class="sb__panel-eyebrow">Shop the Look</p>
                <h2 class="sb__panel-title">Styled by the Street.</h2>
                <p class="sb__panel-sub">Click a hotspot to explore the piece.</p>
            </div>
